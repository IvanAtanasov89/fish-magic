function fish_prompt --description 'Write out the prompt'
    ...
    echo -n -s (set_color -o $fish_color_user) "$USER" $normal ' ' (set_color -o cyan) (prompt_pwd) $normal (__fish_vcs_prompt) $normal $prompt_status (set_color -o bryellow) $suffix " "
end
